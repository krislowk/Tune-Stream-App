...
data class MediaMetadata(
    ...
    fun toYTItem() = SongItem(
        id = id,
        title = title,
        artists = artists.map { com.vynce.vynceclient.models.Artist(name = it.name, id = it.id) },
        album = album?.let { com.vynce.vynceclient.models.Album(name = it.title, id = it.id) },
        duration = duration,
